...
<html>
    <head>
        ...
        <?php
            ...
            $campId=$_GET['id'];
            $sel = @mysqli_query($conn, "SELECT * FROM education WHERE id = '$campId'");
    ...
    <body>
        ...
        <div>
            ...
            <div class="ubuntu-font p-3 d-flex justify-content-between align-items-center bg-success d-block d-md-none">
                ...
                <div style="display: none;" class="campId"><?php echo $_GET['id'] ?></div>
            </div>
            ...
            <div class="ubuntu-font row mt-3">
                <div class="col-sm-12 col xs-12 col-md-8 p-4 campDetails">
