...
<html>
    <head>
        ...
        <?php
            ...
            $storyId=$_GET['id'];
            $sel = @mysqli_query($conn, "SELECT * FROM story WHERE id = '$storyId'");
    ...
    <body>
        <div>
            ...
            <div class="ubuntu-font p-3 d-flex justify-content-between align-items-center bg-success d-block d-md-none">
                <div>
                    <h5 class="text-white">Success Story</h5>
                    <span style="font-size: 10px;"><a class="text-white" href="../" style="text-decoration: none;">Home</a></span><span style="font-size: 10px;" class="text-white"> > Success story</span>
                </div>
                ...
                <div style="display: none;" class="storyId"><?php echo $_GET['id'] ?></div>
            </div>
            <div class="ubuntu-font p-3 bg-success d-none d-md-block">
                <div class="d-flex flex-row justify-content-between align-items-center">
                    <div>
                        <h3 class="text-white">Success Story</h3>
                        <a class="text-white" href="../" style="text-decoration: none;">Home</a><span class="text-white"> > Success story</span>
                    </div>
                    <div class="d-flex flex-column">
            ...
            <div class="ubuntu-font row m-3">
                <div class="col-sm-12 col xs-12 col-md-8 p-4 storyDetails">
